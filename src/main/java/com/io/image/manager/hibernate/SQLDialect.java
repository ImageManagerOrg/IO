package com.io.image.manager.hibernate;
...
public class SQLDialect extends Dialect {
    ...
    private static final SQLDialectIdentityColumnSupport IDENTITY_COLUMN_SUPPORT = new SQLDialectIdentityColumnSupport();
